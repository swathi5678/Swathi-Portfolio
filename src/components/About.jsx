      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            {[
              "I'm an AI & Data Science engineer from SRM Easwari College of Engineering, Chennai. I build intelligent systems that solve real problems, from ML-powered fraud detection to cybersecurity intelligence platforms.",
